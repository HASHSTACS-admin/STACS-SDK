...
public class AsyncRespBO {
	...
	public enum asyncResponseCodesEnum {
		...
		SIGNATURE_VERIFICATION_FAILED("SIGNATURE_VERIFICATION_FAILED","100004"),
		...
		INCORRECT_PAYMENT_RECORD_SNAPSHOT("INCORRECT_PAYMENT_RECORD_SNAPSHOT","200051"),
		...
		SYSTEM_EXCEPTION("SYSTEM_EXCEPTION","500000")
